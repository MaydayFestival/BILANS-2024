...
\item \textbf{Delta ($dépenses - recettes$) : 0,00 €} (\textit{budget équilibré})
\end{itemize}
...
Plusieurs types d'enveloppes ressortent : 
\begin{itemize}
\item Financement par l'université de Bordeaux : 71 078,70 €
\item Financement sur enveloppe CVEC (FSDIE inclus) : 69 500 €À
...
\begin{itemize}
\item Budget réel 2023 : 179 873,87 €
\item Budget réel 2024 : 150 627,40 €
...
\begin{center}
\begin{table}[h!]
\caption{Voici le tableau comparatif des budgets 2023 et 2024 du festival Mayday}
\begin{threeparttable}
\begin{tabular}{|c|c|c|c|c|}
\hline
Catégorie des dépenses & Budget réel 2023 & Budget réel 2024 & Écart & Variation (\%) \\
\hline
Création et technique & 113 323,51 € & 115 387,09 € & + 2 063,58 € & + 1,79 \% \\
Déplacements, restauration & 26 963,06 € & 31 533,15 € & + 4 570,09 € & + 14,50 \% \\
Communication & 30 311,18 €\tnote{a} & 3 707,16 € & - 26 604,02 € & - 87,72 \% \\
\hline
Total & 179 873.87 € & 150 627.40 € & - 29 246.47 € & - 19.42 \%\\
\hline
\end{tabular}
\begin{tablenotes}
...
\begin{itemize}
\item Les dépenses liées à la création et technique ont été légèrement supérieure au budget de 2023, cela s'explique par le passage à 2 jours de fesival et le contexte économique actuel.
\item Les dépenses liées aux déplacements et à la restauration ont été nettement supérieures au budget de 2023, cela correspond au changement opéré sur la restauration\footnote{Voir plus dans la partie innovations de l'édition 2024}.
