...
\begin{itemize}
\item Un manque de cohésion et de collaboration est palpable au sein de l'équipe, entravant une dynamique de travail constructive,
...
\item Le déroulement des réunions est perçu comme peu intéressant ou n'engage que faiblement les équipes, limitant leur implication,
\item Le format des réunions, jugé inadapté, et leur durée excessive contribuent à la lassitude et au désintérêt des participants,
\end{itemize}
