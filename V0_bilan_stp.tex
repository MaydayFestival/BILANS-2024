...
Le festival se déroulant sur le campus universitaire de sciences durant une période d'activité relativement forte, l'organisation du festival devait s'adapter : 
\begin{itemize}
\item Niveau de bruit faible pendant les horaires d'enseignements ainsi que la nuit (voisinage),
\item Maintenir les accès, notamment PMR, entre les différents bâtiments,
\item Signaler les déviations, notamment vélo, pour traverser le campus,
